var _a;
import { reactive, getCurrentInstance as getCurrentInstance$1, effectScope, ref, markRaw, toRaw, inject as inject$1, watch, unref, isRef, isReactive, toRef, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, version as version$1, watchEffect, defineComponent as defineComponent$1, h, resolveComponent, shallowRef, isReadonly, capitalize, camelize, provide, createVNode, mergeProps, readonly, TransitionGroup, Transition, withDirectives, Fragment as Fragment$1, resolveDirective, vShow, Text, resolveDynamicComponent, cloneVNode, warn, toHandlers, Teleport, createTextVNode, vModelText, Suspense, withCtx, useSSRContext, toDisplayString, onErrorCaptured, onServerPrefetch, defineAsyncComponent, createApp } from "vue";
...
import { createMemoryHistory, createRouter, RouterView, useRouter as useRouter$2 } from "vue-router";
...
import { ssrRenderStyle, ssrRenderComponent, ssrRenderAttrs, ssrInterpolate, ssrRenderSuspense } from "vue/server-renderer";
...
function defineStore(idOrOptions, setup, setupOptions) {
  ...
  function useStore(pinia, hot) {
    ...
    (process.env.NODE_ENV === "test" && activePinia && activePinia._testing ? null : pinia) || currentInstance && inject$1(piniaSymbol, null);
    if (pinia)
      setActivePinia(pinia);
...
const components$1 = {};
const components_plugin_O0gbMP1Haq = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/arena-_id_-7a65dc87.js").then((m) => m.default || m)
  },
  {
    name: "authentication",
    path: "/authentication",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/authentication-b68d6f4a.js").then((m) => m.default || m)
  },
  {
    name: "explore",
    path: "/explore",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/explore-71418492.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-80f5c517.js").then((m) => m.default || m)
  },
  {
    name: "personal",
    path: "/personal",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/personal-50124936.js").then((m) => m.default || m)
  },
  {
    name: "settings",
    path: "/settings",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/settings-2019df15.js").then((m) => m.default || m)
  }
];
...
const vuetify_QwmrB3LYDa = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const useLoginStore = defineStore("login", () => {
  let token = ref(useLocalStorage("token-store", {}, {
    mergeDefaults: true
  }));
  const sharedEmail = ref();
  const isUserLoggedIn = ref(false);
  async function setToken(tokenArgs) {
    console.log("before useLocalStorage", tokenArgs);
    token = ref(useLocalStorage("token-store", {
      token: tokenArgs
    }, {
      mergeDefaults: true
    }));
    console.log("after useLocalStorage", token);
  }
  ...
  return { token, sharedEmail, setToken, setEmail, setLoginState, isUserLoggedIn };
});
const useAuthenticationTypeStore = defineStore("AuthType", () => {
  const isLoginForm = ref(false);
  return { isLoginForm };
});
const useSidebarWidthStore = defineStore("sidebarWidth", () => {
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div id="sidebar-button"> &lt; &gt; </div><div id="sidebar-container" style="${ssrRenderStyle({ width: unref(sidebarStore).sidebarWidth })}">`);
      if (!unref(sidebarStore).collapsed) {
        _push(`<nav>`);
        ...
        if (unref(loginStore).sharedEmail) {
          _push(ssrRenderComponent(_component_NuxtLink, { to: "/personal" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(` Personal `);
              } else {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, { to: "/authentication" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(` Personal `);
              } else {
...
const SideBar = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__file", "C:/Users/kmba2/Coding/Projects in coding/Yessay/client/src/Components/SideBar.vue"]]);
const HeaderComponent_vue_vue_type_style_index_0_scoped_fd335a97_lang = "";
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(_attrs)} data-v-fd335a97><div id="search" data-v-fd335a97>`);
      ...
      _push(`</div>`);
      if (unref(loginStore).isUserLoggedIn) {
        _push(ssrRenderComponent(_component_v_btn, {
          id: "userSettings",
          variant: "tonal",
          onClick: () => {
            unref(router).push("/settings");
          }
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(loginStore).sharedEmail)}`);
            } else {
              return [
                createTextVNode(
                  toDisplayString(unref(loginStore).sharedEmail),
                  1
                  /* TEXT */
                )
              ];
        ...
        _push(ssrRenderComponent(_component_v_btn, {
          ...
          variant: "tonal",
          onClick: () => {
            unref(authStore).isLoginForm = true;
            unref(router).push("/authentication");
          }
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../src/Components/HeaderComponent.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const HeaderComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-fd335a97"], ["__file", "C:/Users/kmba2/Coding/Projects in coding/Yessay/client/src/Components/HeaderComponent.vue"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _cssVars = { style: {
        "--3094d2c4-sidebarWidth": unref(sidebarWidth)
      } };
      _push(`<!--[-->`);
      _push(ssrRenderComponent(HeaderComponent, _cssVars, null, _parent));
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "not-header" }, _cssVars))}>`);
      _push(ssrRenderComponent(SideBar, null, null, _parent));
      _push(`<div id="router-view-container">`);
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "C:/Users/kmba2/Coding/Projects in coding/Yessay/client/src/App.vue"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-f8a13013.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-357d45d7.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const RootComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/kmba2/Coding/Projects in coding/Yessay/client/node_modules/nuxt/dist/app/components/nuxt-root.vue"]]);
if (!globalThis.$fetch) {
...
export {
  ...
  useAuthenticationTypeStore as b,
  createError as c,
  useLoginStore as d,
  entry$1 as default,
  defineStore as e,
